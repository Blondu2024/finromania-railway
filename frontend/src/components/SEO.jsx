...
export const SEO = ({
  ...
  image = 'https://finromania-4.preview.emergentagent.com/og-image.jpg',
  url = 'https://finromania-4.preview.emergentagent.com',
  type = 'website',
  author = 'FinRomania',
  publishedTime,
  modifiedTime,
  ...
  const websiteSchema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://finromania-4.preview.emergentagent.com/search?q={search_term_string}",
  ...
  const organizationSchema = {
    ...
    "name": "FinRomania",
    "url": "https://finromania-4.preview.emergentagent.com",
    "logo": "https://finromania-4.preview.emergentagent.com/logo.png",
  ...
  const articleSchema = type === 'article' ? {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://finromania-4.preview.emergentagent.com/logo.png"
      }
    },
