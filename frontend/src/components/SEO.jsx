...
export const SEO = ({
  ...
  image = 'https://bvb-global.preview.emergentagent.com/og-image.jpg',
  url = 'https://bvb-global.preview.emergentagent.com',
  type = 'website',
  author = 'FinRomania',
  publishedTime,
  modifiedTime,
  ...
  const websiteSchema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://bvb-global.preview.emergentagent.com/search?q={search_term_string}",
  ...
  const organizationSchema = {
    ...
    "name": "FinRomania",
    "url": "https://bvb-global.preview.emergentagent.com",
    "logo": "https://bvb-global.preview.emergentagent.com/logo.png",
  ...
  const articleSchema = type === 'article' ? {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://bvb-global.preview.emergentagent.com/logo.png"
      }
    },
