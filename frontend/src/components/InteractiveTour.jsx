...
const tourSteps = [
  ...
  // ========== NAVIGATION MENU - DESKTOP ==========
  {
    ...
    description: 'Cursuri GRATUITE de trading - de la începător la avansat! 32 de lecții interactive.',
    position: 'bottom',
    icon: GraduationCap,
    mobileSkip: true,
  },
  ...
  },
  {
    ...
    title: '📈 Acțiuni BVB',
    description: 'Toate acțiunile de pe Bursa București cu prețuri LIVE, grafice și analize!',
    position: 'bottom',
    icon: BarChart3,
    mobileSkip: true,
  },
  {
    ...
    title: '🌍 Piețe Globale',
    description: 'S&P 500, NASDAQ, Bitcoin, Aur, Petrol - piețele mondiale într-un singur loc!',
    position: 'bottom',
    icon: Globe,
    mobileSkip: true,
  },
  ...
  },
  {
    ...
    description: 'Nu rata niciun dividend! Vezi când și cât plătesc companiile BVB.',
    position: 'bottom',
    icon: Calendar,
    mobileSkip: true,
  },
  {
    ...
    description: 'Știri live din România și internaționale, traduse automat cu analiză AI!',
    position: 'bottom',
    icon: Newspaper,
    mobileSkip: true,
  },
  {
    ...
    description: 'Curs BNR în timp real. Convertește rapid între RON, EUR, USD!',
    position: 'bottom',
    icon: DollarSign,
    mobileSkip: true,
  },
  ...
  // ========== USER ACTIONS ==========
  {
    id: 'darkmode',
    type: 'spotlight',
    selector: 'header button[class*="ghost"]',
    title: '🌙 Mod Întunecat',
  ...
  // ========== MOBILE ONLY - HERO CARDS ==========
  {
    id: 'hero-mobile-1',
    type: 'spotlight',
    selector: 'section a[href="/trading-school"], main a[href="/trading-school"]',
    title: '🎓 Educație GRATUITĂ',
    description: '32 de lecții gratuite de trading și finanțe personale! Începe acum!',
    position: 'bottom',
    icon: GraduationCap,
    mobileOnly: true,
  },
  {
    id: 'hero-mobile-2',
    type: 'spotlight',
    selector: 'section a[href="/stocks"], main a[href="/stocks"]',
    title: '📈 Date BVB Live',
    description: 'Prețuri în timp real pentru toate acțiunile de pe Bursa București!',
    position: 'bottom',
    icon: BarChart3,
    mobileOnly: true,
  },
  {
    id: 'hero-mobile-3',
    type: 'spotlight',
    selector: 'section a[href="/global"], main a[href="/global"]',
    title: '🌍 Piețe Mondiale',
    description: 'S&P 500, Bitcoin, Aur - urmărește toate piețele internaționale!',
    position: 'bottom',
    icon: Globe,
    mobileOnly: true,
  },
  {
    id: 'hero-mobile-4',
    type: 'spotlight',
    selector: 'section a[href="/screener"], main a[href="/screener"]',
    title: '🔧 Instrumente PRO',
    description: 'Screener, Calendar Dividende, Convertor - toate uneltele de care ai nevoie!',
    position: 'bottom',
    icon: Star,
    mobileOnly: true,
  },
  ...
  // ========== FINAL ==========
  {
    ...
    description: 'Creează-ți un cont GRATUIT pentru Watchlist, Portofoliu Virtual și Alerte personalizate!',
    icon: Zap,
