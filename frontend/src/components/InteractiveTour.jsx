...
const tourSteps = [
  ...
  // ========== NAVIGATION MENU - DESKTOP ==========
  {
    ...
    title: '🎓 Școala de Trading',
    description: 'De la bazele pieței de capital la strategii avansate — lecții structurate cu quiz-uri.',
    position: 'bottom',
    icon: GraduationCap,
    mobileSkip: true,
  },
  {
    ...
    title: '💰 Finanțe Personale',
    description: 'Bugete, economii, pensii — fundația oricărei decizii financiare solide.',
    position: 'bottom',
    icon: GraduationCap,
    mobileSkip: true,
  },
  {
    ...
    title: '📈 Piața BVB',
    description: 'Toate acțiunile de pe Bursa București — prețuri, grafice și analiză.',
    position: 'bottom',
    icon: BarChart3,
    mobileSkip: true,
  },
  {
    ...
    title: '🌍 Piețe Globale',
    description: 'S&P 500, NASDAQ, Bitcoin, Aur — piețele mondiale într-un singur loc.',
    position: 'bottom',
    icon: Globe,
    mobileSkip: true,
  },
  {
    ...
    title: '🔍 Screener',
    description: 'Filtrează acțiuni după criterii tehnice și fundamentale.',
    position: 'bottom',
    icon: Star,
    mobileSkip: true,
  },
  {
    ...
    description: 'Toate datele de referință și sumele dividend pentru companiile BVB.',
    position: 'bottom',
    icon: Calendar,
    mobileSkip: true,
  },
  {
    ...
    description: 'Știri din surse românești și internaționale, cu analiză AI.',
    position: 'bottom',
    icon: Newspaper,
    mobileSkip: true,
  },
  {
    ...
    description: 'Curs BNR oficial. Conversii rapide între valute.',
    position: 'bottom',
    icon: DollarSign,
    mobileSkip: true,
  },
