...
const tourSteps = [
  ...
  },
  {
    id: 'logo',
    type: 'spotlight',
    selector: 'header a[href="/"]', // Logo/Home link
    title: 'Acasă',
  ...
  },
  {
    id: 'bvb',
    type: 'spotlight',
    selector: 'nav a[href="/stocks"], header a[href="/stocks"]',
    title: '📈 Acțiuni BVB',
    description: 'Toate acțiunile de pe Bursa de Valori București, cu prețuri LIVE!',
    position: 'bottom',
    icon: BarChart3,
    highlight: true,
    mobileSkip: true, // Skip on mobile - menu is hidden
  },
  {
    id: 'global',
    type: 'spotlight',
    selector: 'nav a[href="/global"], header a[href="/global"]',
    title: '🌍 Piețe Globale',
  ...
  },
  {
    id: 'education',
    type: 'spotlight',
    selector: 'nav a[href="/trading-school"], header a[href="/trading-school"]',
  ...
  },
  {
    id: 'news',
    type: 'spotlight',
    selector: 'nav a[href="/news"], header a[href="/news"]',
  ...
  },
  {
    id: 'calendar',
    type: 'spotlight',
    selector: 'nav a[href="/calendar"], header a[href="/calendar"]',
  ...
  },
  {
    id: 'converter',
    type: 'spotlight',
    selector: 'nav a[href="/converter"], header a[href="/converter"]',
  ...
  },
  {
    id: 'hero-education',
    type: 'spotlight',
    selector: '[href="/trading-school"][class*="gradient"], a[href="/trading-school"]:has(span)',
    title: '🎓 Educație GRATUITĂ',
    description: '32 de lecții gratuite de trading și finanțe. Începe de la zero!',
    position: 'top',
    icon: GraduationCap,
    mobileOnly: true,
  },
  {
    id: 'hero-bvb',
    type: 'spotlight', 
    selector: 'a[href="/stocks"]:has(span), [href="/stocks"][class*="border"]',
    title: '📈 Date BVB Live',
  ...
  },
  {
    id: 'darkmode',
    type: 'spotlight',
    selector: 'button[class*="ghost"]:has(.lucide-sun), button[class*="ghost"]:has(.lucide-moon)',
    title: '🌙 Mod Întunecat',
