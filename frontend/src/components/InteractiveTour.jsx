...
const tourSteps = [
  // ========== WELCOME ==========
  {
    ...
    description: 'Hai să-ți arăt toate funcțiile platformei. Durează doar 2 minute!',
    icon: Sparkles,
  ...
  // ========== NAVIGATION - DESKTOP ==========
  {
    ...
    selector: 'nav a[href="/"]',
    title: '🏠 Acasă',
    description: 'Pagina principală cu toate informațiile importante la un loc.',
    position: 'bottom',
    icon: BarChart3,
    mobileSkip: true,
  },
  {
    id: 'nav-trading',
    type: 'spotlight',
    selector: 'nav a[href="/trading-school"]',
    title: '🎓 Învață Trading',
    description: 'Cursuri GRATUITE de trading - de la începător la avansat!',
    position: 'bottom',
    icon: GraduationCap,
    mobileSkip: true,
  },
  {
    id: 'nav-education',
    type: 'spotlight',
    selector: 'nav a[href="/financial-education"]',
    title: '💰 Educație Financiară',
    description: 'Lecții despre finanțe personale, economii și investiții inteligente.',
    position: 'bottom',
    icon: GraduationCap,
    mobileSkip: true,
  },
  {
    id: 'nav-bvb',
    type: 'spotlight',
    selector: 'nav a[href="/stocks"]',
    title: '📈 Acțiuni BVB',
    description: 'Toate acțiunile de pe Bursa București cu prețuri LIVE și grafice!',
    position: 'bottom',
    icon: BarChart3,
    mobileSkip: true,
  },
  {
    id: 'nav-global',
    type: 'spotlight',
    selector: 'nav a[href="/global"]',
    title: '🌍 Piețe Globale',
    description: 'S&P 500, NASDAQ, Bitcoin, Aur, Petrol - piețele mondiale!',
    position: 'bottom',
    icon: Globe,
    mobileSkip: true,
  },
  {
    id: 'nav-screener',
    type: 'spotlight',
    selector: 'nav a[href="/screener"]',
    title: '🔍 Screener Acțiuni',
    description: 'Filtrează și găsește cele mai bune acțiuni după criterii personalizate!',
    position: 'bottom',
    icon: Star,
    mobileSkip: true,
  },
  ...
  },
  {
    id: 'nav-news',
    type: 'spotlight',
    selector: 'nav a[href="/news"]',
    title: '📰 Știri Financiare',
    description: 'Știri live traduse în română cu analiză AI integrată!',
    position: 'bottom',
    icon: Newspaper,
    mobileSkip: true,
  },
  ...
  // ========== HERO SECTION ==========
  {
    id: 'hero-section',
    type: 'spotlight',
    selector: 'section[class*="gradient"], [class*="hero"], .rounded-2xl.bg-gradient-to-br',
    title: '✨ Secțiunea Principală',
    description: 'Aici găsești acces rapid la cele mai importante funcții ale platformei!',
    position: 'bottom',
    icon: Sparkles,
  },
  ...
  // ========== SEARCH ==========
  {
    id: 'search',
    type: 'spotlight',
    selector: 'input[placeholder*="Caută"], input[type="search"], input[type="text"]',
    title: '🔍 Caută Orice',
    description: 'Caută acțiuni, știri, termeni din glosar - găsești totul instant!',
    position: 'bottom',
    icon: Star,
    mobileSkip: true,
  },
  ...
  // ========== USER ACTIONS ==========
  {
    id: 'darkmode',
    type: 'spotlight',
    selector: 'header button:has(.lucide-sun), header button:has(.lucide-moon), button[class*="ghost"]:has(svg[class*="lucide"])',
    title: '🌙 Mod Întunecat',
    description: 'Schimbă între modul luminos și întunecat pentru confortul ochilor!',
    position: 'bottom',
    icon: Star,
  },
  {
    id: 'login-btn',
    type: 'spotlight',
    selector: 'button:has(.lucide-user), [class*="UserMenu"] button',
    title: '👤 Conectare',
    description: 'Creează cont GRATUIT pentru Watchlist, Portofoliu și Alerte personalizate!',
    position: 'left',
    icon: Star,
  },
  ...
  // ========== MOBILE HERO CARDS ==========
  {
    id: 'hero-education-mobile',
    type: 'spotlight',
    selector: 'a[href="/trading-school"][class*="p-"], [href="/trading-school"] span',
    title: '🎓 Educație GRATUITĂ',
    description: '32 de lecții gratuite de trading și finanțe personale!',
    position: 'top',
    icon: GraduationCap,
    mobileOnly: true,
  },
  {
    id: 'hero-bvb-mobile',
    type: 'spotlight',
    selector: 'a[href="/stocks"][class*="p-"], [href="/stocks"] span',
    title: '📈 Date BVB Live',
    description: 'Prețuri în timp real pentru toate acțiunile românești!',
    position: 'top',
    icon: BarChart3,
    mobileOnly: true,
  },
  {
    id: 'hero-global-mobile',
    type: 'spotlight',
    selector: 'a[href="/global"][class*="p-"], [href="/global"] span',
    title: '🌍 Piețe Mondiale',
    description: 'S&P 500, Bitcoin, Aur - urmărește piețele internaționale!',
    position: 'top',
    icon: Globe,
    mobileOnly: true,
  },
  {
    id: 'hero-tools-mobile',
    type: 'spotlight',
    selector: 'a[href="/screener"][class*="p-"], [href="/screener"] span',
    title: '🔧 Instrumente PRO',
    description: 'Screener, Calendar Dividende, Convertor - toate uneltele!',
    position: 'top',
    icon: Star,
    mobileOnly: true,
  },
  ...
  // ========== FINAL ==========
  {
    ...
    description: 'Acum cunoști toate funcțiile platformei! Creează-ți un cont GRATUIT pentru experiența completă.',
    icon: Zap,
