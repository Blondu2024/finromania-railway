...
const tourSteps = [
  ...
  // ========== MOBILE ONLY - HERO CARDS ==========
  {
    ...
    description: 'Lecții structurate de trading și finanțe personale — la ritmul tău.',
    position: 'bottom',
    icon: GraduationCap,
    mobileOnly: true,
  },
  {
    ...
    title: '📈 Date BVB',
    description: 'Piața românească fără intermediari — prețuri și grafice în timp real.',
    position: 'bottom',
    icon: BarChart3,
    mobileOnly: true,
  },
  {
    ...
    description: 'S&P 500, Bitcoin, Aur — totul într-un singur loc.',
    position: 'bottom',
    icon: Globe,
    mobileOnly: true,
  },
  {
    ...
    title: '🔧 Instrumente',
    description: 'Screener, Calendar Dividende, Convertor — pentru decizii informate.',
    position: 'bottom',
    icon: Star,
    mobileOnly: true,
  },
