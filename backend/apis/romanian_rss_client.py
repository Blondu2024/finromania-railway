"""Romanian RSS News Client - știri din surse românești"""
import feedparser
import requests
...
class RomanianRSSClient:
    """Client pentru știri financiare din România via RSS"""
    
    # Surse RSS românești de știri financiare
    RSS_SOURCES = [
        {
    ...
    def fetch_all_news(self, limit_per_source: int = 10) -> List[Dict]:
        """Obține știri de la toate sursele RSS românești"""
        all_articles = []
